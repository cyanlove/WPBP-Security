...
Note that previous versions of the Boilerplate did not include `wpbp_security_Loader` but this class is used to register all filters and actions with WordPress.
