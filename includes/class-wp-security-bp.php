...
class WP_Security_BP {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      WP_Security_BP_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'WP_SECURITY_BP_VERSION' ) ) {
			$this->version = WP_SECURITY_BP_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wp-security-bp';
	 ...
	 *
	 * - wp_security_bp_Loader. Orchestrates the hooks of the plugin.
	 * - wp_security_bp_i18n. Defines internationalization functionality.
	 * - wp_security_bp_Admin. Defines all hooks for the admin area.
	 * - wp_security_bp_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wp-security-bp-loader.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wp-security-bp-public.php';

		$this->loader = new WP_Security_BP_Loader();
	 ...
	 *
	 * Uses the wp_security_bp_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new WP_Security_BP_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new WP_Security_BP_Public( $this->get_wp_security_bp(), $this->get_version() );
	 ...
	 */
	public function get_wp_security_bp() {
	 ...
	 *
	 * @since     1.0.0
	 * @return    wp_security_bp_Loader    Orchestrates the hooks of the plugin.
	 */
